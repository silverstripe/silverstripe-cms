{
    ...
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.BATCHACTIONSDELETECONFIRM": "¿Realmente quieres eliminar la carpeta %s?",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.ConfirmDelete": "¿Realmente quieres eliminar esta carpeta y todo su contenido?",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.MOVING": "Moviendo %s archivo(s)",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.REALLYDELETE": "¿Realmente quieres eliminar los archivos marcados?",
    "SilverStripe\\Assets\\Folder.Name": "Nombre de la carpeta",
    "SilverStripe\\CMS\\Controllers\\CMSMain.Archive": "¿Está seguro de querer archivar esta página y todas sus páginas hijas?\n\nEsta página y todas sus hijas se retirarán de publicación y se enviarán al archivo.",
    "SilverStripe\\CMS\\Controllers\\CMSMain.ConfirmRestoreFromLive": "¿Estás seguro de que quieres revertir el borrador a la última página publicada?",
    "SilverStripe\\CMS\\Controllers\\CMSMain.DeleteFromDraft": "¿Estás seguro de que quieres remover tu página desde el borrador?\n\nEsta página continuará publicada en el sitio.",
    "SilverStripe\\CMS\\Controllers\\CMSMain.Restore": "¿Estás seguro que quieres restaurar esta página desde el archivo?",
    "SilverStripe\\CMS\\Controllers\\CMSMain.RestoreToRoot": "¿Estás seguro que quieres restaurar esta página desde el archivo?\n\nEl padre de esta página no está disponible, debido a ello, esta página será restaurada en el primer nivel del árbol",
    "SilverStripe\\CMS\\Controllers\\CMSMain.RollbackToVersion": "¿Realmente quieres volver a la versión #%s de esta página?",
    "SilverStripe\\CMS\\Controllers\\CMSMain.Unpublish": "¿Estás seguro que quieres remover tu página desde el sitio publicado?\n\nEsta página se mantendrá disponible en el árbol de páginas como un borrador.",
