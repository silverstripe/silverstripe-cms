{
    ...
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.BATCHACTIONSDELETECONFIRM": "Vuoi veramente eliminare %s cartelle?",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.ConfirmDelete": "Vuoi veramente eliminare questa cartella e tutti i suoi file?",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.MOVING": "Spostamento di %s file(s).",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.REALLYDELETE": "Vuoi veramente eliminare i file selezionati?",
    "SilverStripe\\Assets\\Folder.Name": "Nome cartella",
    "SilverStripe\\CMS\\Controllers\\CMSMain.Archive": "Sei sicuro di voler archiviare questa pagina con tutti i sui figli?\n\nQuesta pagina e tutti i suoi figli saranno spubblicati e archiviati.",
    "SilverStripe\\CMS\\Controllers\\CMSMain.ConfirmRestoreFromLive": "Si è sicuri di voler ripristinare questa bozza all'ultima volta che è stata pubblicata?",
    "SilverStripe\\CMS\\Controllers\\CMSMain.DeleteFromDraft": "Si è sicuri di voler eliminare la pagina dal sito bozza?\n\nQuesta pagina rimarrà disponibile nel sito pubblico.",
    "SilverStripe\\CMS\\Controllers\\CMSMain.Restore": "Si è sicuri di voler ripristinare questa pagina dall'archivio?",
    "SilverStripe\\CMS\\Controllers\\CMSMain.RestoreToRoot": "Si è sicuri di voler ripristinare questa pagina dall'archivio?\n\nPoiché la pagina genitore non è disponibile, questo ripristinerà al primo livello.",
    "SilverStripe\\CMS\\Controllers\\CMSMain.RollbackToVersion": "Vuoi veramente tornare alla versione #%s di questa pagina?",
    "SilverStripe\\CMS\\Controllers\\CMSMain.Unpublish": "Si è sicuri di voler eliminare la pagina dal sito pubblico?\n\nQuesta pagina sarà comunque disponibile nel SiteTree come bozza.",
