{
    ...
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.BATCHACTIONSDELETECONFIRM": "Да бъдат ли изтрити %s папки?",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.ConfirmDelete": "Да бъде ли изтрита тази папка и нейното съдържание?",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.MOVING": "Преместване на %s файл(а)",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.REALLYDELETE": "Да бъдат ли изтрити маркираните файлове?",
