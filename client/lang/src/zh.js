{
    ...
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.BATCHACTIONSDELETECONFIRM": "是否确定删除 %s 个文件夹？",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.ConfirmDelete": "是否确定删除该文件夹以及所有包含的文件？",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.MOVING": "正在移动 %s 文件",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.REALLYDELETE": "是否确定删除标记的文件？",
    ...
    "SilverStripe\\CMS\\Controllers\\CMSMain.RollbackToVersion": "是否确定回滚至该页面的第 #%s 版？",
