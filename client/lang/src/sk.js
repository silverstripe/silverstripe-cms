{
    ...
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.BATCHACTIONSDELETECONFIRM": "Skutočne chcete smazať %s zložky?",
    ...
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.MOVING": "Premiestňujú sa %s súbor(y)",
    "SilverStripe\\AssetAdmin\\Controller\\AssetAdmin.REALLYDELETE": "Skutočne chcete smazať označené súbory?",
    "SilverStripe\\Assets\\Folder.Name": "Názov složky",
    "SilverStripe\\CMS\\Controllers\\CMSMain.Archive": "Určite chcete archivovať túto stránku a jej všetky postránky?\n\nTáto stránka a jej všetky podstránky budú nezverejnené a odoslané do archívu.",
    "SilverStripe\\CMS\\Controllers\\CMSMain.ConfirmRestoreFromLive": "Určite chcete obnoviť koncept do doby, kedy bola stránka naposledy zverejnená?",
    "SilverStripe\\CMS\\Controllers\\CMSMain.DeleteFromDraft": "Určite chcete odstrániť stránku z konceptu?\n\nTáto stránka ostane na zverejneném webu.",
    "SilverStripe\\CMS\\Controllers\\CMSMain.Restore": "Určite chcete obnoviť túto stánku z archívu?",
    "SilverStripe\\CMS\\Controllers\\CMSMain.RestoreToRoot": "Určite chcete obnoviť túto stránku z archívu?\n\nPretože nadriadená stránka nie je k dispozícii, bude obnovena do najvyššej úrovne.",
    "SilverStripe\\CMS\\Controllers\\CMSMain.RollbackToVersion": "Skutočne chcete vrátiť späť na verziu #%s tejto stránky?",
    "SilverStripe\\CMS\\Controllers\\CMSMain.Unpublish": "Určite chcete odstrániť stránku zo zverejneného webu?\n\nTáto stránka bude stále k dispozícii v štruktúre webu ako koncept.",
