...
var AnchorSelectorField = function (_SilverStripeComponen) {
  ...
  _createClass(AnchorSelectorField, [{
    ...
    value: function ensurePagesLoaded() {
      ...
      if (props.loadingState === _AnchorSelectorStates2.default.UPDATING || props.loadingState === _AnchorSelectorStates2.default.SUCCESS || !props.pageId) {
...
function mapStateToProps(state, ownProps) {
  ...
  if (page && (page.loadingState === _AnchorSelectorStates2.default.SUCCESS || page.loadingState === _AnchorSelectorStates2.default.DIRTY)) {
