...
Feature: Create a page
  ...
  Scenario: I can create a page using the context menu
    ...
    And I click on "Error Page" in the context menu
    Then I should see "New Error Page" in the tree
    # The triple dash (---) here denotes it is a child of the previous page
    And the site tree order should be "--MyPage,---New Error Page,--MyVirtualPage"
