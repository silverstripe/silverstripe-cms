...
Feature: Search for a page
  ...
  Scenario: I can search for a page by its title
    ...
    Then I should see "About Us" in the list
    But I should not see "Contact Us" in the list
  ...
  Scenario: I can search for a page by its type
    ...
    And I press the "Search" button
    Then I should see "My Virtual Page" in the list
    But I should not see "Contact Us" in the list
  ...
  Scenario: I can search for a page by its oldest last edited date
    ...
    And I press the "Search" button
    Then I should see "Recent Page" in the list
    But I should not see "Old Page" in the list
  ...
  Scenario: I can search for a page by its newest last edited date
    ...
    And I press the "Search" button
    Then I should not see "Recent Page" in the list
    But I should see "Old Page" in the list
  ...
  Scenario: I can include changed pages in my search
    ...
    And I press the "Search" button
    Then I should see "About Us" in the list
    And I should not see "Home" in the list
  ...
  Scenario: I can include live pages in my search
    ...
    When I press the "Search" button
    Then I should not see "Live Page" in the list
    When I expand the content filters
    And I select "Live but removed from draft" from "Page status"
    And I press the "Search" button
    Then I should see "Live Page" in the list
    And I should not see "About Us" in the list
  ...
  Scenario: I can include only live pages in my search
    ...
    And I press the "Search" button
    Then I should not see "Draft Page" in the list
    And I should not see "Deleted Page" in the list
    But I should see "Live Page" in the list
