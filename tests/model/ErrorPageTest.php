...
class ErrorPageTest extends FunctionalTest {
	...
	public function test404ErrorPage() {
		...
		/* Status code of the response for error page is "404" */
		$this->assertEquals($response->getStatusCode(), '404', 'Status code of the response for error page is "404"');
		
		/* Status message of the response for error page is "Not Found" */
