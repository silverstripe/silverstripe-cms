    ...
    public function requireDefaultRecords()
    {
        ...
        if (static::class === SiteTree::class && $this->config()->get('create_default_pages')) {
            ...
            if (!SiteTree::get_by_link($defaultHomepage)) {
                ...
                $homepage->Content = _t(__CLASS__.'.DEFAULTHOMECONTENT2', '<p>Welcome to Silverstripe! This is the default homepage. You can edit this page by opening <a href="admin/">the CMS</a>.</p><p>For comprehensive information on the Silverstripe CMS, see the <a target="_blank" href="http://docs.silverstripe.org">developer documentation</a>.</p>');
