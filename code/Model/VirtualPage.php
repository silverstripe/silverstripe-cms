...
class VirtualPage extends Page
{
     ...
     * Note that anything in {@link VirtualPage::config()->initially_copied_fields} is implicitly included in this list.
     */
    ...
    protected function refreshFromCopied()
    {
        ...
        if ($this->isChanged('CopyContentFromID', 2) && $this->CopyContentFromID) {
            foreach (VirtualPage::config()->get('initially_copied_fields') as $fieldName) {
