...
if((typeof tinyMCE != 'undefined')) {
	tinyMCE.init({
		...
		//extended_valid_elements : "img[class|src|alt|title|hspace|vspace|width|height|align|onmouseover|onmouseout|name],script[src|type],object[width|height|type|data|classid|codebase],param[value|name],embed[src|quality|wmode|pluginspage|type|width|height]"
	});
}
